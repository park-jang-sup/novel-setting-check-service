        ...
        {!isIntroCollapsed && (
          <div className="mt-2 space-y-3">
            ...
            <div className="space-y-2 text-sm text-[var(--foreground)]">
              <p className="font-medium">사용 순서</p>
              <ol className="list-decimal pl-5 space-y-1">
                <li>설정집과 원고를 넣고 검사하기를 누릅니다.</li>
                <li>설정오류마다 줄 번호와 원문이 함께 나옵니다. 설정집 정밀 검토를 누르면 규칙이 놓친 항목을 AI가 찾아줍니다.</li>
                <li>추가 제안에서 승인한 이름과 용어는 설정집에 추가할 수 있습니다.</li>
                <li>설정오류를 확정하고 원고 수정을 누르면 수정안이 나옵니다. 적용 여부는 직접 고릅니다.</li>
              </ol>
